...
def get_network_usage(interface='Server_3-eth0', interval=1, output_file='/home/harshit/proj/Draft/Server/logging/log3.txt', status_file='/home/harshit/proj/Draft/Server/status/status3.txt'):
    try:
        while True:

...
def get_network_usage(interface='Server_1-eth0', interval=1, output_file='/home/harshit/proj/Draft/Server/logging/log1.txt', status_file='/home/harshit/proj/Draft/Server/status/status1.txt'):
    try:
        while True:
